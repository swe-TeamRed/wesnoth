...
mapbuilder::~mapbuilder()
{
	...
	//Remember that the member variable resetters_ is destroyed here
}
...
void mapbuilder::pre_build()
{
	...
	for (unit& u : *resources::units) {
		...
		if(!on_current_side && !u.is_visible_to_team(resources::gameboard->get_team(viewer_side()), resources::gameboard->map(), false)) {
